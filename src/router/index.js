  ...
  // GIS地理信息系统
  {
    ...
    children: [{
    ...
    },
      {
        ...
        name: 'Lamp',
        meta: {title: '灯具地理信息', icon: '', noshow: true}
      }]
  },
  // 事件报警系统
  {
