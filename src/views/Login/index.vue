    ...
    <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm"
      ...
      <div class="login-center-block">
        <el-form-item>
          ...
          <el-input name="username" type="text" prop="userName" v-model="loginForm.username" autoComplete="on"
                    placeholder="请输入用户名"/>
        </el-form-item>
        <el-form-item>
          <span class="svg-container svg-container_login">
          ...
          <el-input name="password" :type="passwordType" prop="passWord" @keyup.enter.native="handleLogin"
                    v-model="loginForm.password" autoComplete="on" placeholder="请输入密码"/>
        </el-form-item>
        <el-checkbox v-model="loginForm.isRememberMe">记住密码</el-checkbox>
        <el-button type="primary" class="sub-button" :loading="loading" @click.native.prevent="handleLogin">登录
        </el-button>
      </div>
    </el-form>
  </div>
