  ...
  <div class="system-container">
    <el-tabs v-model="activeName" @tab-click="tabHandleClick">
      <el-tab-pane label="控制柜模式" name="cabinet">
        <div class="system-top clearfix">
          <div class="item-block f-l">
            <span class="title">控制柜ID</span>
            <el-input placeholder="请输入" v-model="boxId"></el-input>
          </div>
          <div class="item-block f-l">
            <span class="title">控制柜编码</span>
            <el-input placeholder="请输入" v-model="boxCode"></el-input>
          </div>
          <div class="btn-block f-r">
            <el-button type="primary" @click="searchBox">查询</el-button>
          </div>
        </div>
        <div class="system-center">
          ...
          <div class="data-list">
            <el-table
              ...
              <el-table-column fixed prop="uid" label="ID" width="120"></el-table-column>
              <el-table-column fixed prop="codeNumber" label="编码" width="120"></el-table-column>
      ...
      <el-tab-pane label="灯具模式" name="lighting">
        <div class="system-top clearfix">
          <div class="item-block f-l">
            <span class="title">灯具ID</span>
            <el-input placeholder="请输入" v-model="lightId"></el-input>
          </div>
          <div class="item-block f-l">
            <span class="title">唯一编码</span>
            <el-input placeholder="请输入" v-model="lightCode"></el-input>
          </div>
          <div class="btn-block f-r">
            <el-button type="primary" @click="getListLighting">查询</el-button>
          </div>
        </div>
        <div class="system-center">
          <div class="operation-bar">
    ...
    <el-dialog title="添加设备" width="1200px"
      ...
      <div class="add-device clearfix">
        <div class="device-info">
          <el-form label-width="150px" ref="addNewEleboxModelForm" :model="newEleboxModel" :rules="addNewEleboxModel"
                   size='small'>
    ...
    <el-dialog title="添加回路" width="560px"
      ...
      <el-form ref="addNewModelLoopForm" label-width="120px" :model="newModelLoop" :rules="addNewModelLoopRules"
               size='small'>
    ...
    <el-dialog title="批量增加灯具" width="630px"
      ...
      <div class="uid-dgh-item clearfix">
        ...
        <div class="item-block f-l">
          ...
          <el-input v-model="MoreLampObj.uidNum" placeholder="请输入"></el-input>
        </div>
        <div class="item-block f-l" style="width:160px">
          <span class="title">每次递增</span>
    ...
    <el-dialog title="编辑控制柜" width="617px"
      ...
      <el-form ref="editCabinetForm" class="lamp-form" :model="newElebox" :rules="editNewEleboxRules"
               label-width="140px" size='small'>
        ...
        <div class="modeloop-split-center clearfix">
          <div class="split-center-left clearfix">
            ...
            <div class="center-left-item">
              <p v-for="(item, index) in listEleboxModel" :class="selectEleboxModelId==item.id?'activep':''"
                 @click="selectEleboxModel(item.id)" v-bind:key="index">{{item.modelName}}</p>
            </div>
            <div class="center-left-item" style="float:right">
              <p v-for="(item, index) in listModelLoop" v-bind:key="index"
                 :class="selectModelLoopId==item.id?'activep':''" @click="selectModelLoop(item.id)">
                {{item.loopCode}}</p>
            </div>
          </div>
